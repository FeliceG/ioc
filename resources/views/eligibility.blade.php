...
<div class="content">
  ...
  <h3 class="bold">Eligibility</h3>
  	...
  	<p>Each author can submit <span class="bold">up to two different submissions</span> of papers and/or posters.</p>
	  ...
	  <h3 class="bold">Poster Competition</h3>
    ...
    <p class="bold">All those invited to submit a poster will be entered into the Best Poster competition.</p>
      ...
      <p class="bold">The first author of the two Honorable Mention awards will receive a one year complementary Affiliate Membership in the IOC.</p>
